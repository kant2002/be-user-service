...
import { AuthServiceDefinition } from '@kant2002-diia-inhouse/auth-service-client'
...
import { NotificationServiceDefinition } from '@kant2002-diia-inhouse/notification-service-client'
