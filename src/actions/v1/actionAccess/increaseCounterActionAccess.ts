...
import { ActionResult, CustomActionArguments } from '@interfaces/actions/v1/actionAccess/increaseCounterActionAccess'
import { ActionAccessType } from '@interfaces/services/userActionAccess'

export default class IncreaseCounterActionAccessAction implements AppAction {
    ...
    readonly name: string = 'increaseCounterActionAccess'
    ...
    async handler(args: CustomActionArguments): Promise<ActionResult> {
        ...
        return await this.userActionAccessService.increaseCounterActionAccess(userIdentifier, actionAccessType)
    }
}
