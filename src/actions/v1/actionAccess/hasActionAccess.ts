...
import { ActionResult, CustomActionArguments } from '@interfaces/actions/v1/actionAccess/hasActionAccess'
import { ActionAccessType } from '@interfaces/services/userActionAccess'

export default class HasActionAccessAction implements AppAction {
    ...
    readonly name: string = 'hasActionAccess'
    ...
    async handler(args: CustomActionArguments): Promise<ActionResult> {
        ...
        return await this.userActionAccessService.hasActionAccess(userIdentifier, actionAccessType)
    }
}
